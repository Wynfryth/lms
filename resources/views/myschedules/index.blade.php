        ...
        <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                {{-- <li>
                    ...
                    <a href="{{ route('myschedules') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Jadwal Saya</a>
                    </div>
                </li> --}}
            </ol>
        </nav>
    ...
    $(document).ready(function () {
        ...
        var events = events.map(function(item){
            switch(item.enrollment_status){
                case "REGISTERED":
                    colors.push("#f3f4f6");
                    textColors.push("#363f4b");
                break;
                case "ON GOING":
                    colors.push("#edebfe");
                    textColors.push("#6233bb");
                break;
                case "PASSED":
                    colors.push("#def7ec");
                    textColors.push("#196550");
                break;
                case "FAILED":
                    colors.push("#fde8e8");
                    textColors.push("#b04747");
                break;
                case "CANCELLED":
                    colors.push("#000000");
                    textColors.push("#f5f5f5");
                break;
                default:
                    colors.push("#f0f9ff");
            ...
            return {
                title: item.session_name+' - '+item.Employee_name,
