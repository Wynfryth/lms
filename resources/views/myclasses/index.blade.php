                        ...
                        @forelse ($myclasses as $index => $myclass)
                            ...
                            @endif
                                <div class="flex flex-col h-full p-5">
                                    ...
                                    {{-- @if ($myclass->enrollment_status == 'PASSED' || $myclass->enrollment_status == 'FAILED') --}}
                                        {{-- @if ($myclass->feedbackId == null) --}}
                                            {{-- <div class="flex items-center">
                                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 13V4M7 14H5a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1h-2m-1-5-4 5-4-5m9 8h.01"/>
                                                </svg> <a class="hover:underline" href="{{route('feedback.create', ['enrollment' => $myclass->id])}}">Masukan dan Rating Kelas</a>
                                            </div> --}}
                                        {{-- @else --}}
                                            <div class="flex items-center">
                                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 13V4M7 14H5a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1h-2m-1-5-4 5-4-5m9 8h.01"/>
                                                </svg>  <a class="hover:underline" href="{{route('myclasses.certificate', ['class_id' => $myclass->class_id, 'nip' => Auth::user()->nip])}}">Unduh Sertifikat</a>
                                            </div>
                                            {{-- <div class="flex items-center">
                                                <svg class="w-6 h-6 text-green-800 dark:text-green" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                                    <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm13.707-1.293a1 1 0 0 0-1.414-1.414L11 12.586l-1.793-1.793a1 1 0 0 0-1.414 1.414l2.5 2.5a1 1 0 0 0 1.414 0l4-4Z" clip-rule="evenodd"/>
                                                </svg> Masukan dan Rating Kelas telah diisi
                                            </div> --}}
                                        {{-- @endif --}}
                                    {{-- @else --}}
                                    {{-- @endif --}}
                                    <div class="flex items-center">
                                        ...
                                        </svg> &nbsp;{{date('d/m/Y', strtotime($myclass->start_eff_date))}} {{date('H:i:s', strtotime($myclass->start_eff_time))}}
                                    </div>
