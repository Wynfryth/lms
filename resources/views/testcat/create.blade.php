    ...
    <div class="p-4 sm:ml-64">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <form method="POST" action="{{ route('testcat.store') }}" class="mt-6 space-y-6">
                    @csrf
                    {{-- @method('put') --}}

                    <div>
                        <x-input-label for="kategori_tes" :value="__('Nama Kategori Tes')" />
                        <x-text-input id="kategori_tes" name="kategori_tes" type="text" class="mt-1 block w-full" value="{{ old('kategori_tes') }}"/>
                        @error('kategori_tes')
                    ...
                    <div>
                        ...
                        <x-textarea-input id="deskripsi_kategori_tes" name="deskripsi_kategori_tes" class="mt-1 block w-full">{{ old('deskripsi_kategori_tes') }}</x-textarea-input>
