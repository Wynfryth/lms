                ...
                <div class="p-6 overflow-x-auto text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="testcat_kywd" id="table-search" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cari data" value="{{ $testcat_kywd }}">
                        </div>
                    </div>
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table id="detail_table" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @forelse ($testcats as $index => $value)
                                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $index + $testcats->firstItem() }}
                                        </th>
                                        <td class="px-6 py-4">
                                            {{ $value->test_category }}
                                        </td>
                                        ...
                                        <td class="px-6 py-4" width="15%">
                                            @if ($value->is_active == 1)
                                                <div class="flex flex-column sm:flex-row flex-wrap space-y-2 sm:space-y-0 items-center justify-between">
                                                    ...
                                                    <a type="button" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('testcat.edit', $value->id) }}">Edit</a>
                                                    @endcan
...
<script>
    ...
    $('body').off('keypress', '[name="testcat_kywd"]').on('keypress', '[name="testcat_kywd"]', function(e){
        if(e.which == 13) {
            var testcat_kywd = $(this).val();
            var url = "{{ route('testcat', ['testcat_kywd' => ':testcat_kywd']) }}";
            url = url.replace(':testcat_kywd', testcat_kywd);
