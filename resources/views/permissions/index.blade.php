                ...
                <div class="p-6 overflow-x-auto text-gray-900 dark:text-gray-100">
                    <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="table-search" name="permissions_keyword" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cari data" value="{{ $permission_keyword }}">
                        </div>
                    </div>
                                    ...
                                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                            {{-- @if ($value->is_active == 1) --}}
                                                ...
                                                <x-edit-link-button class="mx-auto" href="{{ route('permissions.edit', $value->id) }}">
                                                    Edit
                                                </x-edit-link-button>
                                                @endcan
...
<script>
    ...
    $('body').off('keypress', '[name="permissions_keyword"]').on('keypress', '[name="permissions_keyword"]', function(e){
        if(e.which == 13) {
            var permissions_keyword = $(this).val();
            var url = "{{ route('permissions', ['permission_keyword' => ':permissions_keyword']) }}";
            url = url.replace(':permissions_keyword', permissions_keyword);
