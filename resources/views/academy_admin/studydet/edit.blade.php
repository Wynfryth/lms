        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <form method="POST" action="{{ route('academy_admin.studies.update', $item->id) }}" class="mt-6 space-y-6">
                    ...
                    <div class="my-1">
                        <x-add-button data-modal-target="default-modal" data-modal-toggle="default-modal">
                            + Tambah
                        </x-add-button>
                                            ...
                                            <td class="px-6 py-4">
                                                @if (count($filename) > 1)
                                                    <ul class="list-disc">
                                                        ...
                                                        <li>
                                                            <a href="{{$attachment[$filename_index]}}">{{$filename_item}}</a>
                                                        </li>
                                                        @endforeach
                                                    </ul>
                                                @else
                                                    <a href="{{$value->attachment}}">{{$value->filename}}</a>
                                                @endif
                                            </td>
                                            <td class="px-6 py-4">
