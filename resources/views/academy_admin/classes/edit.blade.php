    ...
    <div class="p-2 sm:ml-64">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                {{-- {{dd(Input::all())}} --}}
                <form method="POST" action="{{ route('academy_admin.classes.update', $item->id) }}" class="mt-6 space-y-6">
                    @csrf
                    {{-- @method('put') --}}
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                <div>
                                    ...
                                    <x-text-input id="periode_efektif_kelas_mulai" name="periode_efektif_kelas_mulai" type="text" class="mt-1 block w-full datepicker" value="{{ date('d-m-Y', strtotime($item->start_eff_date)) }}" />
                            ...
                            <div>
                                <div>
                                    ...
                                    <x-text-input id="periode_efektif_kelas_sampai" name="periode_efektif_kelas_sampai" type="text" class="mt-1 block w-full datepicker" value="{{ date('d-m-Y', strtotime($item->end_eff_date)) }}" />
