                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('academy_admin.classcat.index')" :active="request()->routeIs('academy_admin.classcat.index')">
                                    {{ __('Kategori Kelas') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
