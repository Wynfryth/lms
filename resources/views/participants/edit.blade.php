    ...
    <div class="p-4 sm:ml-64">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <form method="post" action="{{ route('academy_admin.classcat.update', $item->id) }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="kategori_kelas" name="kategori_kelas" type="text" class="mt-1 block w-full"
                            value="{{ $item->class_category }}" />
                    ...
                    <div>
                        ...
                        <x-textarea-input id="deskripsi_kategori_kelas" name="deskripsi_kategori_kelas"
